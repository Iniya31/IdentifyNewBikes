...
//    private WebElement movemouse;
//
//    @FindBy(xpath = "//a[contains(@href,'/upcoming-bikes')]")
//    private WebElement newbike;
//
//    @FindBy(xpath = "//a[contains(@href,'/upcoming-honda-bikes')]")
//    private WebElement hondaBrand;
//
//    //
//    @FindBy(xpath = "//li[@id='Scooters']")
//    private WebElement scooterFilter;
//
//    @FindBy(xpath = "//strong")
...
//
//    @FindBy(xpath = "//*[contains(text(),'Expected Launch')]")
//    private List<WebElement> launchDates;
////
//
//    public void clickUpcomingBikes() {
//
//        actions.moveToElement(movemouse).perform();
//        wait.until(ExpectedConditions.elementToBeClickable(newbike));
//        newbike.click();
//    }
//
...
//
//        // Scroll to Honda element
//        js.executeScript(
//                "arguments[0].scrollIntoView({block:'center'});",
//                hondaBrand);
//
//        // Click Honda
//        js.executeScript("arguments[0].click();", hondaBrand);
//    }
//
//
//    public void printScooterDetails() {
//
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//
//        // Wait until scooter filter is clickable and click it
//        wait.until(ExpectedConditions.elementToBeClickable(scooterFilter));
//        scooterFilter.click();
//
//        // Wait until list is refreshed and scooter names are visible
//        wait.until(ExpectedConditions.visibilityOfAllElements(scooterNames));
//
//        // Optional: wait until at least one scooter is displayed
//
//
//        System.out.println("Total Scooters Found: " + scooterNames.size());
//
//        for (int i = 0; i < scooterNames.size(); i++) {
//
//            System.out.println("Name : " + scooterNames.get(i).getText());
//
//            if (i < scooterPrices.size()) {
//                System.out.println("Price : " + scooterPrices.get(i).getText());
//            }
//
//            if (i < launchDates.size()) {
//                System.out.println("Launch : " + launchDates.get(i).getText());
//            }
//
//            System.out.println("--------------------------------");
//        }
...
public class BikesPage {
    ...
    @FindBy(xpath = "//div[contains(text(),'Expected Leaunch')]")
